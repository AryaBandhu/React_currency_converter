    ...
    <>
      ...
      >
        <div className="w-full">
          <div className="w-full max-w-md mx-auto border border-gray-60 rounded-3xl p-5 backdrop-blur-sm bg-white/30 my-2">
            <h1 className=" font-bold text-gray-900 font-mono text-3xl" >Currency Converter
             <a className=" font-bold text-sm text-white"><i> Arya Bandhu</i></a></h1>
          </div>
